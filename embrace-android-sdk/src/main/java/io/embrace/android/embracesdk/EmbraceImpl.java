...
final class EmbraceImpl {
    ...
    @NonNull
    private final InternalEmbraceLogger internalEmbraceLogger = new InternalEmbraceLogger();
    ...
    private void startImpl(@NonNull Context context,
        ...
        moduleInitBootstrapper.init(context, enableIntegrationTesting, framework, startTimeMs, internalEmbraceLogger, customAppId);
