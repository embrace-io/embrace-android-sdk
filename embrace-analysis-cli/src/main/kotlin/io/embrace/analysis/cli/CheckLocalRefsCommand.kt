 ...
 * can gate a commit.
 *
 * Modeled on `_shared/check_leaks.py` in the production `sdk-startup` repo, which is a live tool
 * there - see [io.embrace.analysis.localrefs.LocalRefsCheck] for what this checker keeps from that
 * script and where it deliberately differs. The checker itself knows no repository
