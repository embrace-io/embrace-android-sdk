...
public class Embrace private constructor(
    ...
    @Deprecated("Use {@link #start(Context)} instead. The isDevMode parameter has no effect.")
    override fun start(context: Context, isDevMode: Boolean, appFramework: AppFramework) {
        impl.start(
            context,
            appFramework
        ) { _: io.embrace.android.embracesdk.internal.payload.AppFramework? -> null }
    ...
    override fun startMoment(name: String) {
        startMoment(name, null)
    }

    override fun startMoment(name: String, identifier: String?) {
        impl.startMoment(name, identifier)
    }
    ...
    override fun endMoment(name: String, identifier: String?) {
        impl.endMoment(name, identifier)
    }
