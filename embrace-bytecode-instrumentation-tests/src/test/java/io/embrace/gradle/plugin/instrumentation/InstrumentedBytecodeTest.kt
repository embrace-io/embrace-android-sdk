...
private val sdkInitializationFactory: ClassVisitorFactory = { visitor, params ->
    createFactory(params, visitor, "sdk_initialization", "android.app.Application")
}
...
class InstrumentedBytecodeTest(
    ...
    companion object {
        ...
        fun testCases() = listOf(
            ...
            BytecodeTestParams(clz = TestApplication::class, factory = sdkInitializationFactory),
