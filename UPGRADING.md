...
- Removed capture of memory warnings as this is no longer supported by apps targeting Android API 34 and above, which is now mandatory for Play Store submissions
