...
abstract class EmbraceBytecodeInstrumentation @Inject internal constructor(objectFactory: ObjectFactory) {
    ...
    /**
     * Whether Embrace should automatically instrument its initialization. Defaults to false.
     */
    val sdkInitializationEnabled: Property<Boolean> = objectFactory.property(Boolean::class.java)
