...
/**
 * [java.util.concurrent.ThreadFactory] that creates thread with a constant name. Useful if you want to
 * ensure the same executor produces threads with the  same name. Use the uniquePerInstance parameter
 * to use the instance's hashcode to provide relative uniqueness across instances of this thread factory.
 */
