...
internal class SessionMessageTest {
    ...
    private val type = object: TypeToken<SessionMessage<Session>>() {}.type
    ...
    fun testDeserialization() {
        ...
        val obj = Gson().fromJson<SessionMessage<Session>>(json, type)
        assertNotNull(obj)
        assertEquals(session, obj.data)
    ...
    @Test
    fun testEmptyObject() {
        val info = Gson().fromJson<SessionMessage<Session>>("{}", type)
        assertNotNull(info)
    }
}
