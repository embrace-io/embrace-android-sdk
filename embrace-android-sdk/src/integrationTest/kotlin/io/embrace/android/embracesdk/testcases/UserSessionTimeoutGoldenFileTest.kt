    ...
    fun `session end max duration`() {
        testRule.runTest(
            ...
            assertAction = {
                ...
                assertSessionSpanMatchesGoldenFile(sessions[0], "user_session_max_duration_1.json")
                assertSessionSpanMatchesGoldenFile(sessions[1], "user_session_max_duration_2.json")
