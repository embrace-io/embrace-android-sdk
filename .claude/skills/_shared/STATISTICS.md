...
Companion to the statistics core of the `embrace-analysis-stats` module, the method of record behind
...
comparing, using `Power.requiredN(cvPct, effectPct, deff = 1.0)` in `embrace-analysis-stats` - deff = 1 because the pass is already
