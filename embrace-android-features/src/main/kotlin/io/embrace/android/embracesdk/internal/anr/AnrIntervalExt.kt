 ...
 * redacted.
 */
public fun AnrInterval.size(): Int = anrSampleList?.size() ?: 0

/**
 * Calculates the duration of the interval, returning -1 if this is unknown.
 */
public fun AnrInterval.duration(): Long {
 ...
 */
public fun AnrInterval.deepCopy(): AnrInterval {
...
@CheckResult
public fun AnrInterval.clearSamples(): AnrInterval = copy(anrSampleList = null, code = AnrInterval.CODE_SAMPLES_CLEARED)

public fun AnrInterval.hasSamples(): Boolean = code != AnrInterval.CODE_SAMPLES_CLEARED
