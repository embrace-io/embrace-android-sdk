...
sealed class InternalErrorType(private val severity: Severity) {
    ...
    object SpanTimeoutSweepFail : InternalErrorType(ERROR)
    ...
    object SessionPartEndMissed : InternalErrorType(ERROR)
    object OrphanedSessionSpan : InternalErrorType(ERROR)
