...
internal class EmbraceLogRecordDataTest {
    ...
    fun testDeserialization() {
        val deserializedLog = deserializeJsonFromResource<Log>("log_expected.json")
        assertEquals(testLog.traceId, deserializedLog.traceId)
        assertEquals(testLog.spanId, deserializedLog.spanId)
        assertEquals(testLog.timeUnixNano, deserializedLog.timeUnixNano)
    ...
    fun testSerialization() {
        ...
        val deserializedLog = serializer.fromJson(serializedLogJson, Log::class.java)
