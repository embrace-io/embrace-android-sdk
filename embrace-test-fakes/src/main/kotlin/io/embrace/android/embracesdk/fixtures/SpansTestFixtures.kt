...
public val MAX_LENGTH_ATTRIBUTE_KEY: String = "s".repeat(EmbraceSpanImpl.MAX_ATTRIBUTE_KEY_LENGTH)
public val TOO_LONG_ATTRIBUTE_KEY: String = "s".repeat(EmbraceSpanImpl.MAX_ATTRIBUTE_KEY_LENGTH + 1)
...
public val tooBigEvents: List<EmbraceSpanEvent> = createEventsListOfSize(EmbraceSpanImpl.MAX_EVENT_COUNT + 1)
