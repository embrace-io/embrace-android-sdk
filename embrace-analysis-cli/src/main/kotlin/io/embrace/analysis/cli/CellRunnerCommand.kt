...
import io.embrace.analysis.campaign.CellRunner
...
class CellRunnerCommand : CliktCommand(name = "cell-runner") {
    ...
    private val out by option("--out", help = "run directory (default: <repo>/${RecordsRoot.LOCAL_REL}/data/runs/vfm-<run_id>)").path()
