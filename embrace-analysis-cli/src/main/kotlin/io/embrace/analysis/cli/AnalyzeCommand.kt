...
class AnalyzeCommand : CliktCommand(name = "analyze") {
    ...
    private val outputDir by option(
        "--output-dir",
        help = "directory for the timestamped summary file (default: <repo root>/${RecordsRoot.REL}/analyses)",
    )
        .path()
    ...
    override fun run() {
        ...
        val outDir = outputDir ?: RecordsRoot.dir(repo ?: RepoRoot.locate()).resolve("analyses")
