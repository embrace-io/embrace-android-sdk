 ...
 *
 * Embrace session part span attributes
 *
...
object EmbSessionAttributes {
    ...
    object EmbUserSessionTerminationReasonValues {
        ...
        /**
         * Background-only user session ended because the app entered the foreground.
         */
        @ExperimentalSemconv
        const val BACKGROUND_ONLY_USER_SESSION_FOREGROUNDED: String = "background_only_user_session_foregrounded"

        /**
         * The current timestamp is before the active session, so the user session cannot continue.
         */
        @ExperimentalSemconv
