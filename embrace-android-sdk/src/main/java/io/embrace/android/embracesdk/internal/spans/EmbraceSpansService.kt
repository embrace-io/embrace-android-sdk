 ...
 */
internal class EmbraceSpansService(private val clock: Clock) : Initializable, SpansService, ConfigListener {
    /**
    ...
    override fun <T> recordSpan(
        ...
        currentDelegate.recordSpan(
            name = name,
            parent = parent,
            type = type,
            internal = internal,
            recordSystrace = recordSystrace,
            code = code
        )
