...
class TestBytecodeInstrumentationParams(
    ...
    instrumentSdkInitialization: Boolean = false,
    ...
    override val shouldInstrumentSdkInitialization: Property<Boolean> =
        DefaultProperty(PropertyHost.NO_OP, Boolean::class.javaObjectType).convention(instrumentSdkInitialization)
