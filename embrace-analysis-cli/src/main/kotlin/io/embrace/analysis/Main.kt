...
import io.embrace.analysis.cli.ReplicatesCommand
import io.embrace.analysis.cli.ReproduceCommand
...
fun allCommands(): List<CliktCommand> = listOf(
    ...
    // The complete set of tools: one subcommand per analysis, each an adapter from flags to a library call.
)
