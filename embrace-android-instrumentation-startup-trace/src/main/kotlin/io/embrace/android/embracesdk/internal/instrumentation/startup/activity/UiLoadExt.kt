...
/**
 * Creates [io.embrace.android.embracesdk.internal.session.lifecycle.ActivityLifecycleListener] that maps
 * Activity lifecycle events to the given [UiLoadEventListener].
