...
abstract class EmbraceExtension @Inject internal constructor(objectFactory: ObjectFactory) {
     ...
     * Defaults to false.
     */
    val autoAddEmbraceComposeDependency: Property<Boolean> = objectFactory.property(Boolean::class.java).convention(false)

    /**
     * Whether the Embrace Gradle Plugin should automatically upload mapping files for stacktrace deobfuscation.
     * Defaults to true.
     */
    val mappingFileUploadEnabled: Property<Boolean> = objectFactory.property(Boolean::class.java).convention(true)
    // TODO: support
     ...
     * Defaults to true.
     */
    val telemetryEnabled: Property<Boolean> = objectFactory.property(Boolean::class.java).convention(true)
    // TODO: support
     ...
     */
    val bytecodeInstrumentation: EmbraceBytecodeInstrumentation = objectFactory.newInstance(EmbraceBytecodeInstrumentation::class.java)
